const links = [
    { name: 'Rôles ouverts', href: '#' },
    { name: 'Programme de stage', href: '#' },
    { name: 'Nos valeurs', href: '#' },
    { name: 'Rencontrez notre direction', href: '#' },
]
const stats = [
    { name: 'Formations', value: '12' },
    { name: 'Intervenants', value: '300+' },
    { name: 'Clients satisfaits', value: '40' },
    { name: 'Temps libre payé', value: 'Illimité' },
]
